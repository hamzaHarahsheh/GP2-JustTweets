...
import { LightMode as SunIcon, DarkMode as MoonIcon, School as SchoolIcon, CloudUpload as CloudUploadIcon } from '@mui/icons-material';
            ...
            <Box sx={{ 
                ...
                >
                    <Box sx={{ 
                        ...
                        >
                            Create your account and become part of the university community
                        </Typography>
                    </Box>
                </Box>
                    ...
                    >
                        <Box sx={{ textAlign: 'center', mb: 4 }}>
                            ...
                            <Typography 
                                ...
                                sx={{ opacity: 0.8 }}
                            >
                                Join your university social network
                            </Typography>
                        </Box>
                        ...
                        <Box component="form" onSubmit={handleSubmit} sx={{ width: '100%' }}>
                            ...
                            >
                                {profilePicture ? `Selected: ${profilePicture.name}` : 'Upload Profile Picture (Optional)'}
                                <input
                                    type="file"
                                    hidden
                                    accept="image/*"
                            ...
                            <Button
                                ...
                                sx={{ 
                                    ...
                                    boxShadow: isFormValid ? '0 8px 25px rgba(29, 161, 242, 0.3)' : 'none',
                                    transition: 'all 0.3s ease',
                                    '&:hover': {
                                        transform: isFormValid ? 'translateY(-2px)' : 'none',
                                        boxShadow: isFormValid ? '0 12px 35px rgba(29, 161, 242, 0.4)' : 'none',
                                    },
                                    '&:active': {
